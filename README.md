...
- ### Universal
  ...
  [funzig🗒️Fun functional functionality for Zig!](https://github.com/ziglibs/funzig)
    - ![Star](https://img.shields.io/github/stars/yamafaktory/hyperzig?color=orange)
  [HyperZig🗒️Hypergraph Implementation in Zig](https://github.com/yamafaktory/hyperzig)
